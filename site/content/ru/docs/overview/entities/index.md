...
UI/UX — это один из источников [сложности]({{< relref "introduction#plasticity" >}}). Помимо этого, в UI сосредоточена большая часть платформенных различий между клиентскими приложениями. Роутер позволяет инкапсулировать эту сложность.
